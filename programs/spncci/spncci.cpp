...
int main(int argc, char **argv)
{
  ...
  ////////////////////////////////////////////////////////////////
  // contract and branch observables
  ////////////////////////////////////////////////////////////////

  std::cout << "Set up indexing for branching..." << std::endl;

  // set up basis indexing for regrouping and branching
  spncci::BabySpNCCISpace baby_spncci_space(spncci_space);
  spncci::SpaceU3S space_u3s(baby_spncci_space);
  std::map<HalfInt,spncci::SpaceLS> J_spaces_u3ls;  // map: J -> space
  for (const HalfInt J : run_parameters.J_values)
    {
      J_spaces_u3ls[J] = spncci::SpaceLS(space_u3s,J);
    }

  std::cout << "Construct U3S regrouped observable matrices..." << std::endl;

  // regroup observable matrices at U3S level
