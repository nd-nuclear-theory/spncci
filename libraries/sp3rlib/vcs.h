...
void GenerateKMatrices(
    const sp3r::Sp3RSpace& irrep,
    vcs::MatrixCache& K_matrix_map,
    vcs::MatrixCache& Kinv_matrix_map
  );
// Generates K matrices and Kinv matrices


using KmatrixMap =
    std::unordered_map<u3::U3, std::array<basis::OperatorBlock<double>, 2>>;
...
//  zero_threshold(optional) : Threshold for determining if a U(3) irrep should
//  be included in the basis
//    For more detailed discusion, see D. J. Rowe, A. E. McCoy and M. A. Caprio.
//    Phys. Script. 91 (2016) 033003.
//
// Output
