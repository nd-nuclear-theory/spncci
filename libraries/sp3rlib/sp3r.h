...
namespace sp3r 
{
  ...
  typedef std::map< u3::U3,std::vector< MultiplicityTagged<u3::U3> > > RestrictedSpanakopitaType;
  ...
  public:
    ...
    void Init(const std::vector<MultiplicityTagged<u3::U3>>& state_set);
    // Alternative constructor used for Sp->U(3) branching restriction
  ...
  public:
    ...
    Sp3RSpace(const u3::U3& sigma, int Nn_max, const RestrictedSpanakopitaType& spanakopita);
    // Constructs all U3 subspaces up to given Nn_max.
