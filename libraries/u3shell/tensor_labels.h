...
namespace u3shell
{
  ...
  // Note: More likely want to take a relative space as the argument.
  // Not make this a "let me try to do everything for you with Nmax
  // truncation coded in and rebuild all the indexing from scratch
  // even though you probably already built the indexing somewhere
  // else earlier in your program" type of function.
