/****************************************************************
  ...
  3/26/17 (aem): Based on jpv_io (created 5/2/18).
...
//    n' l' n l s j tz rme
// where n is the radial quantum number in 2n+l.
// t is determined by l+s+t odd antisymmetry constraint
// tz=+1 for neutron-neutron, 0 proton-neutron and -1 proton-proton (I think)
