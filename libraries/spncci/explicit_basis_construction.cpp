...
int main(int argc, char **argv)
{
      ...
      for(int j=0; j< prel_sectors.size(); ++j)
        {
          ...
          std::cout<<temp[0]<<std::endl<<std::endl;
          ...
          {
            // std::cout<<"looping over lgi's "<<l<<" of "<<num_lgi<<std::endl;
            ...
            for(int up=0; up<u_max; ++up)
              {
                ...
                // std::cout<<sp_irrep_expansion[ket_index][omega_index]<<std::endl;
  ...
  //       for(auto expansion2 :sp_irrep_expansion[i])
  //       {
  //         if(expansion.rows()!=expansion2.rows())
  //           continue;
  //         std::cout<<"hi"<<std::endl;
  //         // std::cout<<expansion<<std::endl<<std::endl<<expansion2<<std::endl<<std::endl;
  //         basis::MatrixVector temp;
  //         temp.push_back(expansion.transpose()*expansion2);
          
  //         ZeroOutMatrix(temp,1e-3);
  //         std::cout<<temp[0]<<std::endl<<std::endl;
  //       }
  //   }
