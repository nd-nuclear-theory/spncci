...
\begin{align*}
  ...
  &=\sum_{\substack{\omega_1\upsilon_1\\\omega_2\upsilon_2}} \sum_{\substack{n\rho\\n_1\rho_1}}(K_\sigma^\omega)_{\upsilon[n\rho]}^{-1}\frac{2}{N_\omega - N_\sigma}(n\Vert{}a^\dagger\Vert{}n_1) U[(2,0)n_1 x x_\sigma;n\_\rho;x_1\rho_1\_](K_\sigma^{\omega_1})_{[n_1\rho_1],\upsilon_1}\\
  %%%%
  &\times\Bigg\{\sum_{\bar{\rho}_0}\Big(
      \rme{\sigma'\upsilon'\omega'}{A^{(2,0)}}{\sigma'\upsilon_2\omega_2}
      \rme{\gamma'\sigma'\upsilon_2\omega_2S_p'S_n'S'}{\mathcal{U}^{x_0S_0T_0}(\bar{N}'\bar{S}'\bar{T}',\bar{N}\bar{S}\bar{T})}{\gamma\sigma\upsilon_1\omega_1S_pS_nS}_{\bar{\rho}_0}\\
   %%%%
  &\qquad\qquad\times
      (-1)^{\lambda_2+\mu_2+\lambda'+\mu'} U[(2,0) x_1 x' x_0; x \_ \rho_0; x_2\bar{\rho}_0\_]
    \Big)\\
   %%%%
  &\qquad+
  \delta_{\omega',\omega_2}\delta_{\upsilon',\upsilon_2}
  ...
  \rme{\gamma'\sigma'\upsilon_2\omega_2 S_p'S_n'S'}{\mathcal{U}^{x_0'S_0T_0}(\bar{N}'\bar{S}'\bar{T}',\bar{N}\negative2\,\bar{S}\bar{T})}{\gamma\sigma\upsilon_1\omega_1S_pS_nS}_{\bar{\rho}_0}\\
   %%%%
  &\qquad\qquad\times
      (-1)^{\lambda_0+\mu_0+\lambda+\mu}(-1)^{\lambda_1+\mu_1+\lambda_0'+\mu_0'} U[x_1 (2,0) x' x_0; x\_\rho_0;x_0'\_\bar{\rho}_0']
...
\begin{align*}
  ...
  %%%%
  &\times\Bigg\{\sum_{\bar{\rho}_0}\Big(
      \rme{\gamma'\sigma'\upsilon_1\omega_1 S_p' S_n' S'}{\mathcal{U}^{x_0S_0T_0}(\bar{N}'\bar{S}'\bar{T}',\bar{N}\bar{S}\bar{T})}{\gamma \sigma \upsilon_2\omega_2 S_p S_n S}_{\bar{\rho}_0} \, \rme{\sigma \upsilon_2 \omega_2}{B^{(0,2)}}{\sigma \upsilon \omega}\\
   %%%%
  &\qquad\qquad\times
      % \sum_{\rho_1'\bar{\rho}_0\tilde{\omega}_0'\rho_0'}\Phi_{\rho_0\rho_0'}[x' \tilde{x}_0 x] U[\tilde{x}_0(2,0)x x_1;\tilde{x}_0'\_\rho_1';x'\_\rho_0']\Phi_{\rho_1'\bar{\rho}_0}[\tilde{x}_0' x_1 x] U[x_1 \tilde{x}_0 x (2,0);x_2\bar{\rho}\_;\tilde{x}_0'\_\bar{\rho}_0]
      (-1)^{\lambda_2+\mu_2+\lambda+\mu} U[(2,0) x_1 x \tilde{x}_0; x' \_ \rho_0; x_2\bar{\rho}_0\_]
    \Big)\\
   %%%%
  &\qquad+
  ...
  \\
  & \qquad \qquad \times
  \rme{\gamma'\sigma'\upsilon_1\omega_1 S_p' S_n' S'}{\mathcal{U}^{x_0'S_0T_0}(\bar{N}'\negative2\,\bar{S}'\bar{T}',\bar{N}\bar{S}\bar{T})}{\gamma \sigma \upsilon_2 \omega_2 S_p S_n S}_{\bar{\rho}_0}\\
   %%%%
  &\qquad\qquad\times
      % \sum_{\rho_0'\rho_1'}\Phi_{\rho_0\rho_0'}[x' \tilde{x}_0 x] U[\tilde{x}_0 (2,0)x x_1;\tilde{x}_0'\_\rho_1';x'\_\rho_0']\Phi_{\rho_1'\bar{\rho}_0}[\tilde{x}_0' x_1 x]
      (-1)^{\lambda_0+\mu_0+\lambda'+\mu'}(-1)^{\lambda_1+\mu_1+\lambda_0'+\mu_0'} U[x_1 (2,0) x \tilde{x}_0; x'\_\rho_0;\tilde{x}_0'\_\bar{\rho}_0']
